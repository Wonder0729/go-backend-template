...
import (
	...
	"github.com/wonder0729/go-backend-template/internal/data"
	"github.com/wonder0729/go-backend-template/internal/jsonlog"
	"github.com/wonder0729/go-backend-template/internal/mailer"
...
func main() {
	...
	// command-line flag, rather than os.Getenv("GO_BACKEND_TEMPLATE_DB_DSN") like we were
	// previously.
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "GO BACKEND TEMPLATE <no-reply@example.com>", "SMTP sender")
